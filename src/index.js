...
function assignNames() {
    ...
    submitButton.addEventListener('click', () => {
        ...
        const wrongName = document.querySelector('.error-handler');
    
        if (name === '') {
            wrongName.textContent = 'Name field must have a letter at least';
            enterName.appendChild(wrongName);
            return;
        }
...
function generatePlayers(player1Name, player2Name){
...
assignNames();
generatePlayers(player1Name, player2Name);